...
#define NORFLASH_DESC_STR "@NOR Flash        /0x70080000/3456*4Kg" /*13.5MB*/
...
constexpr inline uint32_t NOR_PROGRAM_TIME = 2;
// actually takes 2ms to program, but DFU-util inserts 8ms between reads
