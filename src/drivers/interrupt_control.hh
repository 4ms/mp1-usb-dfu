...
struct InterruptControl {
  ...
  // From Table 3-2 in arm_gic_architecture_specifiation, the group and
  // sub-group are:
  //     ggg.sssss
  // ARM CA7 uses 5-bit priority, and is left-aligned, so bottom 3 sss bits are
  // ignored. So we have:
  //     ggg.ssXXX
  //
  // So, pri1 is upper 3 bits (value can be 0-7), pri2 is next 2 bits (value can
  // be 0-3), and lower 3 bits are ignored
  //
  ...
  static void disable_irq(IRQn_Type irqn) { GIC_DisableIRQ(irqn); }
