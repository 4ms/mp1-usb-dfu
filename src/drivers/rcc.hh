...
// Auto-generated by:
// :s/\v#define RCC_(.{-}ENR)_([^ ]{-})EN[^_] /using \2_ =
// RegisterBits<ReadWrite, RCC_BASE + offsetof(RCC_TypeDef, \1),
// RCC_\1_\2EN>;\r\0
...
// special-case: GPIO port base address can be used to calc bit-offset of RCC
// enable bit
struct GPIO {
